import { Activity, Armchair, ChevronRight, Clapperboard, LayoutDashboard, LogOut, Megaphone, Menu, Settings2, Ticket, UsersRound, X } from 'lucide-react'
...
const icons = { dashboard: LayoutDashboard, movies: Clapperboard, halls: Armchair, sessions: Ticket, marketing: Megaphone, admins: UsersRound }
