...
export function SeatSelectionPage() {
  ...
  const price = selectedSeats.reduce((total, seat) => total + (seat.priceCents || seatMap?.session.basePriceCents || 5000), 0)
